...
export class StartingWithUnknownFunctionHeaderSegmentsRule extends Rule<StartingWithUnknownFunctionHeaderSegmentsConcreteSyntaxTreeNode> {
	public constructor() {
		super("StartingWithUnknownFunctionHeaderSegments");
	}
