...
export class StartingWithKnownFunctionHeaderSegmentsRule extends Rule<StartingWithKnownFunctionHeaderSegmentsConcreteSyntaxTreeNode> {
	public constructor() {
		super("StartingWithKnownFunctionHeaderSegments");
	}
