				...
				switch (optionalFunctionsAbstractifyingResult.typeName) {
					...
					case successAbstractifyingResultTypeName: {
						...
						if (abstractifiedOptionalFunctions === null) {
							const abstractifiedFunctions =
								abstractifiedFunction.createFunctions();
							const functionsAbstractifyingResult: SuccessAbstractifyingResult<FunctionsAbstractSyntaxTreeNode> =
								new SuccessAbstractifyingResult(abstractifiedFunctions);
							return functionsAbstractifyingResult;
						} else {
							const abstractifiedFunctions =
								abstractifiedFunction.putIntoFunctions(
