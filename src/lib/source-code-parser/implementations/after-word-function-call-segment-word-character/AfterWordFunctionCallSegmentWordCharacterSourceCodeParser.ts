...
import type {WithoutBlockContentConcreteSyntaxTreeNodeNodeBuilder} from "../../../concrete-syntax-tree-node/implementations/branch/implementations/block-content/builders/without/WithoutBlockContentConcreteSyntaxTreeNodeNodeBuilder.ts";
...
export class AfterWordFunctionCallSegmentWordCharacterSourceCodeParser
	implements SourceCodeParser
{
	public constructor(
		...
		blockContentBuilder: WithoutBlockContentConcreteSyntaxTreeNodeNodeBuilder,
	...
	public finalizeFeeding(): SupportedFeedingFinalizingResult {
		throw new Error("Method not implemented.");
	}
}
