...
import {doneExecutingStateTypeName} from "./type-name/doneExecutingStateTypeName.ts";
export class DoneExecutingState extends ExecutingState<
	typeof doneExecutingStateTypeName
> {
	public constructor() {
		super(doneExecutingStateTypeName);
	}
