...
import {FunctionCallStatementSegmentsRule} from "../../core/rule/implementations/function-call-statement-segments/FunctionCallStatementSegmentsRule.ts";
...
import {KnownFunctionCallStatementSegmentRule} from "../../core/rule/implementations/known-function-call-statement-segment/KnownFunctionCallStatementSegmentRule.ts";
import {KnownFunctionCallStatementSegmentContentRule} from "../../core/rule/implementations/known-function-call-statement-segmentContent/KnownFunctionCallStatementSegmentContentRule.ts";
...
import {OptionalFunctionCallStatementSegmentsRule} from "../../core/rule/implementations/optional-function-call-statement-segments/OptionalFunctionCallStatementSegmentsRule.ts";
...
import {OptionalKnownFunctionCallStatementSegmentContentRule} from "../../core/rule/implementations/optional-known-function-call-statement-segment-content/OptionalKnownFunctionCallStatementSegmentContentRule.ts";
...
import {OptionalStartingWithKnownFunctionCallStatementSegmentsRestRule} from "../../core/rule/implementations/optional-starting-with-known-function-call-statement-segments-rest/OptionalStartingWithKnownFunctionCallStatementSegmentsRestRule.ts";
...
import {OptionalStartingWithUnknownFunctionCallStatementSegmentsRestRule} from "../../core/rule/implementations/optional-starting-with-unknown-function-call-statement-segments-rest/OptionalStartingWithUnknownFunctionCallStatementSegmentsRestRule.ts";
...
import {OptionalStartingWithWordFunctionCallStatementSegmentsRestRule} from "../../core/rule/implementations/optional-starting-with-word-function-call-statement-segments-rest/OptionalStartingWithWordFunctionCallStatementSegmentsRestRule.ts";
...
import {OptionalUnknownFunctionCallStatementSegmentContentRule} from "../../core/rule/implementations/optional-unknown-function-call-statement-segment-content/OptionalUnknownFunctionCallStatementSegmentContentRule.ts";
...
import {SeparatedOptionalFunctionCallStatementSegmentsRule} from "../../core/rule/implementations/separated-optional-function-call-statement-segments/SeparatedOptionalFunctionCallStatementSegmentsRule.ts";
...
import {StartingWithKnownFunctionCallStatementSegmentsRule} from "../../core/rule/implementations/starting-with-known-function-call-statement-segments/StartingWithKnownFunctionCallStatementSegmentsRule.ts";
import {StartingWithKnownFunctionCallStatementSegmentsRestRule} from "../../core/rule/implementations/starting-with-known-function-call-statement-segments-rest/StartingWithKnownFunctionCallStatementSegmentsRestRule.ts";
...
import {StartingWithUnknownFunctionCallStatementSegmentsRule} from "../../core/rule/implementations/starting-with-unknown-function-call-statement-segments/StartingWithUnknownFunctionCallStatementSegmentsRule.ts";
import {StartingWithUnknownFunctionCallStatementSegmentsRestRule} from "../../core/rule/implementations/starting-with-unknown-function-call-statement-segments-rest/StartingWithUnknownFunctionCallStatementSegmentsRestRule.ts";
...
import {StartingWithWordFunctionCallStatementSegmentsRule} from "../../core/rule/implementations/starting-with-word-function-call-statement-segments/StartingWithWordFunctionCallStatementSegmentsRule.ts";
import {StartingWithWordFunctionCallStatementSegmentsRestRule} from "../../core/rule/implementations/starting-with-word-function-call-statement-segments-rest/StartingWithWordFunctionCallStatementSegmentsRestRule.ts";
...
import {UnknownFunctionCallStatementSegmentRule} from "../../core/rule/implementations/unknown-function-call-statement-segment/UnknownFunctionCallStatementSegmentRule.ts";
import {UnknownFunctionCallStatementSegmentContentRule} from "../../core/rule/implementations/unknown-function-call-statement-segment-content/UnknownFunctionCallStatementSegmentContentRule.ts";
...
import {WordFunctionCallStatementSegmentRule} from "../../core/rule/implementations/word-function-call-statement-segment/WordFunctionCallStatementSegmentRule.ts";
