...
import {createFunctionHeaderAbstractSyntaxTreeNode} from "../../../abstract-syntax-tree/node/kinds/function-header/createFunctionHeaderAbstractSyntaxTreeNode.ts";
...
export function abstractifyFunctionHeader(
	...
	const abstractifiedFunctionHeader: FunctionHeaderAbstractSyntaxTreeNode =
		createFunctionHeaderAbstractSyntaxTreeNode(
