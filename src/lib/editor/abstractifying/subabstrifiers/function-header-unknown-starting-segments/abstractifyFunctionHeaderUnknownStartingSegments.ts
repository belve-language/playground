...
import {subabstractifyFunctionHeaderUnknownSegment} from "../function-header-unknown-segment/subabstractifyFunctionHeaderUnknownSegment.ts";
...
export function subabstractifyFunctionHeaderUnknownStartingSegments(
	...
	const abstractifiedSegmentsFirstSegment: FunctionHeaderUnknownSegmentAbstractSyntaxTreeNode =
		subabstractifyFunctionHeaderUnknownSegment(segmentsFirstSegment);
