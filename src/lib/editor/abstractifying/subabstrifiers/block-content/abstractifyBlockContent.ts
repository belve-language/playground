...
import {subabstractifyStatements} from "../statements/subabstractifyStatements.ts";
export function subabstractifyBlockContent(
	...
	const abstractifiedBlockContentStatements: readonly [
		BlockAbstractSyntaxTreeNode | FunctionCallAbstractSyntaxTreeNode,
		...OperatedStatementAbstractSyntaxTreeNode[],
	] = subabstractifyStatements(blockContentStatements);
