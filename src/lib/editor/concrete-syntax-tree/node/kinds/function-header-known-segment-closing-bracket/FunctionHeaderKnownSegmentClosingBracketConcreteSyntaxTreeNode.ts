...
import type {functionHeaderKnownSegmentClosingBracketConcreteSyntaxTreeNodeKindName} from "./functionHeaderKnownSegmentClosingBracketConcreteSyntaxTreeNodeKindName.ts";
