...
import type {FunctionCallUnknownSegmentContentParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionCallUnknownSegmentContentParserPartialConcreteSyntaxTree.ts";
export class FunctionCallUnknownSegmentContentParser implements Parser {
	private readonly tree: FunctionCallUnknownSegmentContentParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionCallUnknownSegmentContentParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
