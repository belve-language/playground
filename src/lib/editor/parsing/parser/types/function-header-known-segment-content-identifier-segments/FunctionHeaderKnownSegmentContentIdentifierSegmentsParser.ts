...
import type {FunctionHeaderKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionHeaderKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionHeaderKnownSegmentContentIdentifierSegmentsParser
	implements Parser
{
	private readonly tree: FunctionHeaderKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionHeaderKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
