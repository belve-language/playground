...
import type {StatementsRestStatementsBeforeOperatorWhitespaceSegmentsParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/StatementsRestStatementsBeforeOperatorWhitespaceSegmentsParserPartialConcreteSyntaxTree.ts";
export class StatementsRestStatementsBeforeOperatorWhitespaceSegmentsParser
	implements Parser
{
	private readonly tree: StatementsRestStatementsBeforeOperatorWhitespaceSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: StatementsRestStatementsBeforeOperatorWhitespaceSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
