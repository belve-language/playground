...
import type {FunctionCallKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree} from "./FunctionCallKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionCallKnownSegmentContentIdentifierSegmentsParser
	implements Parser
{
	private readonly partialConcreteSyntaxTree: FunctionCallKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		partialConcreteSyntaxTree: FunctionCallKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree,
	) {
	...
	public parseWhitespace(
		...
		const functionCallKnownSegmentContentIdentifier =
	...
	public parseClosingRoundBracket(): never {
		throw new Error(
			"Closing round bracket not allowed in known function call segment.",
		);
	}
	public parseOpeningCurlyBracket(): never {
		throw new Error(
			"Opening curly bracket not allowed in known function call segment.",
		);
	}
	public parseClosingCurlyBracket(): never {
		throw new Error(
			"Closing curly bracket not allowed in known function call segment.",
		);
	}
	public parseOpeningSquareBracket(): never {
		throw new Error(
			"Opening square bracket not allowed in known function call segment.",
		);
	}
	public parseClosingSquareBracket(): never {
		throw new Error(
			"Closing square bracket not allowed in known function call segment.",
		);
	}
