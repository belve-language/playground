...
import type {FunctionCallKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionCallKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionCallKnownSegmentContentIdentifierSegmentsParser
	implements Parser
{
	private readonly tree: FunctionCallKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionCallKnownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
