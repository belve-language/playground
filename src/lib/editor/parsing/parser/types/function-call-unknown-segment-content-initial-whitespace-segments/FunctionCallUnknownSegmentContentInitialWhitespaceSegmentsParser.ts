...
import type {FunctionCallKnownSegmentContentInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree} from "../function-call-known-segment-content-initial-whitespace-segments/partial-concrete-syntax-tree/FunctionCallKnownSegmentContentInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionCallUnknownSegmentContentInitialWhitespaceSegmentsParser
	implements Parser
{
	private readonly tree: FunctionCallKnownSegmentContentInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionCallKnownSegmentContentInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
