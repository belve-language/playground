...
import type {FunctionHeaderSegmentsParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionHeaderSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionHeaderSegmentsParser implements Parser {
	private readonly tree: FunctionHeaderSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionHeaderSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
