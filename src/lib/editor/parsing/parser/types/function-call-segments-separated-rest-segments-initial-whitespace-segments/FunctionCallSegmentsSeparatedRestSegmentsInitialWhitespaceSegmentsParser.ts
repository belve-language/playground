...
import type {FunctionCallSegmentsSeparatedRestSegmentsInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionCallSegmentsSeparatedRestSegmentsInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionCallSegmentsSeparatedRestSegmentsInitialWhitespaceSegmentsParser
	implements Parser
{
	private readonly tree: FunctionCallSegmentsSeparatedRestSegmentsInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionCallSegmentsSeparatedRestSegmentsInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
