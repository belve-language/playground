...
import type {FunctionHeaderKnownSegmentContentInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionHeaderKnownSegmentContentInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionHeaderKnownSegmentContentInitialWhitespaceSegmentsParser
	implements Parser
{
	private readonly tree: FunctionHeaderKnownSegmentContentInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionHeaderKnownSegmentContentInitialWhitespaceSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
