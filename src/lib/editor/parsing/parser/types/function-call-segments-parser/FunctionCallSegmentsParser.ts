...
import type {FunctionCallSegmentsParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionCallSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionCallSegmentsParser implements Parser {
	private readonly tree: FunctionCallSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionCallSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
