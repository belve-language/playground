...
import type {FunctionHeaderWordSegmentIdentifierSegmentsParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionHeaderWordSegmentIdentifierSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionHeaderWordSegmentIdentifierSegmentsParser
	implements Parser
{
	private readonly tree: FunctionHeaderWordSegmentIdentifierSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionHeaderWordSegmentIdentifierSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
