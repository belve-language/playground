...
import type {FunctionHeaderUnknownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionHeaderUnknownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree.ts";
export class FunctionHeaderUnknownSegmentContentIdentifierSegmentsParser
	implements Parser
{
	private readonly tree: FunctionHeaderUnknownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionHeaderUnknownSegmentContentIdentifierSegmentsParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
