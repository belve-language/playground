...
import type {StatementsRestStatementsAfterOperatorWhitespaceSegmentsParserParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/StatementsRestStatementsAfterOperatorWhitespaceSegmentsParserParserPartialConcreteSyntaxTree.ts";
export class StatementsRestStatementsAfterOperatorWhitespaceSegmentsParser
	implements Parser
{
	private readonly tree: StatementsRestStatementsAfterOperatorWhitespaceSegmentsParserParserPartialConcreteSyntaxTree;
	public constructor(
		tree: StatementsRestStatementsAfterOperatorWhitespaceSegmentsParserParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
