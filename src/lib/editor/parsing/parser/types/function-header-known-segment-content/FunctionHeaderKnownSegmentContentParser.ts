...
import type {FunctionHeaderKnownSegmentContentParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionHeaderKnownSegmentContentParserPartialConcreteSyntaxTree.ts";
export class FunctionHeaderKnownSegmentContentParser implements Parser {
	private readonly tree: FunctionHeaderKnownSegmentContentParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionHeaderKnownSegmentContentParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
