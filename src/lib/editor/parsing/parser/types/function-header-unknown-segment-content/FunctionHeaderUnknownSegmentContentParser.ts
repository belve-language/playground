...
import type {FunctionHeaderUnknownSegmentContentParserPartialConcreteSyntaxTree} from "./partial-concrete-syntax-tree/FunctionHeaderUnknownSegmentContentParserPartialConcreteSyntaxTree.ts";
export class FunctionHeaderUnknownSegmentContentParser implements Parser {
	private readonly tree: FunctionHeaderUnknownSegmentContentParserPartialConcreteSyntaxTree;
	public constructor(
		tree: FunctionHeaderUnknownSegmentContentParserPartialConcreteSyntaxTree,
	) {
		this.tree = tree;
	}
