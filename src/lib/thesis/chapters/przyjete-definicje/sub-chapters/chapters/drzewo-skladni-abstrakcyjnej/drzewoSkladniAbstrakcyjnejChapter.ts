...
export const drzewoSkladniAbstrakcyjnejChapter = [
	...
	new PAtomBuilder({marginBlock: "1em 1em"}, [
		new TextAtomBuilder(
			"Drzewiasta struktura danych reprezentująca kod źródłowy w sposób uproszczony – zawiera jedynie informacje istotne z punktu widzenia wykonania programu. Tworzona jest w wyniku abstraktyfikacji drzewa składni konkretnej. Nie można z niej wiernie odtworzyć pierwotnego kodu źródłowego, ponieważ różne reprezentacje konkretne mogą odpowiadać temu samemu drzewu składni abstrakcyjnej. Można jednak, przyjmując ustalone zasady konkretyfikacji, deterministycznie zbudować z niej kod źródłowy, który po ponownej abstraktyfikacji sprowadza się do tej samej reprezentacji abstrakcyjnej.",
		),
	]),
