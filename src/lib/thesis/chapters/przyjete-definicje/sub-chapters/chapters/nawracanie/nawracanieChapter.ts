...
export const nawracanieChapter = [
	...
	new PAtomBuilder({marginBlock: "1em 1em"}, [
		new TextAtomBuilder(
			"Technika algorytmiczna polegająca na eksploracji wszystkich możliwych rozwiązań problemu poprzez systematyczne przeszukiwanie przestrzeni rozwiązań. W przypadku napotkania rozwiązania niepoprawnego lub nieoptymalnego, algorytm cofa się do poprzedniego kroku i próbuje innej ścieżki.",
		),
	]),
