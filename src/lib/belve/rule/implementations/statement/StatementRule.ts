import {statementRuleName} from "./name/statementRuleName.ts";
...
> {
	...
	public override getRightExpressions(
		...
		const rightExpressions: readonly [
			...
			new NonTerminalExpression<FunctionCallStatementConcreteSyntaxTreeNode>(
				ruleById.FunctionCallStatement,
			),
		];
