...
import {ClosingCurlyBracketCharacterConcreteSyntaxTreeNode} from "../../../concrete-syntax-tree-node/implementations/closing-curly-bracket-character/ClosingCurlyBracketCharacterConcreteSyntaxTreeNode.ts";
import type {ClosingCurlyBracketCharacterConcreteSyntaxTreeNodeAtom} from "../../../concrete-syntax-tree-node/implementations/closing-curly-bracket-character/atom/ClosingCurlyBracketCharacterConcreteSyntaxTreeNodeAtom.ts";
...
> {
	...
	public override getRightExpressions(
		...
		const rightExpressions: readonly [
			...
			new TerminalExpression<typeof closingCurlyBracketCharacter>(
