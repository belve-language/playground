	...
	public override getRightExpressions(
		...
		const rightExpressions: readonly [
			...
			new ThenExpression<
				...
				NonTerminalAtom<OptionalVariableNameSegmentCharactersConcreteSyntaxTreeNode>
			>(
				new NonTerminalExpression<VariableNameSegmentCharacterConcreteSyntaxTreeNode>(
					ruleById.VariableNameSegmentCharacter,
				),
				new NonTerminalExpression<OptionalVariableNameSegmentCharactersConcreteSyntaxTreeNode>(
