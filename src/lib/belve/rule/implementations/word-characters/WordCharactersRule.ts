import {wordCharactersRuleName} from "./name/wordCharactersRuleName.ts";
	...
	public override getRightExpressions(
		...
		const rightExpressions: readonly [
			...
			new ThenExpression(
				...
				new NonTerminalExpression<OptionalWordCharactersConcreteSyntaxTreeNode>(
					ruleById.OptionalWordCharacters,
				),
			),
		];
