import {paddedOptionalStatementsRuleName} from "./name/paddedOptionalStatementsRuleName.ts";
...
export class PaddedOptionalStatementsRule extends Rule<
	PaddedOptionalStatementsConcreteSyntaxTreeNodeAtom,
	PaddedOptionalStatementsConcreteSyntaxTreeNode
> {
	public constructor() {
		super(paddedOptionalStatementsRuleName);
	}
	...
	public override getRightExpressions(
		...
		const rightExpressions: readonly [
			...
			>(
				...
				new NonTerminalExpression<OptionalStatementsConcreteSyntaxTreeNode>(
					ruleById.OptionalStatements,
				),
			),
		];
