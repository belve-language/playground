	...
	public override getRightExpressions(
		...
		const rightExpressions: readonly [
			...
			new ThenExpression<
				...
				NonTerminalAtom<OptionalStartingWithWordFunctionCallStatementSegmentsRestConcreteSyntaxTreeNode>
			>(
				new NonTerminalExpression<WordFunctionCallStatementSegmentConcreteSyntaxTreeNode>(
					ruleById.WordFunctionCallStatementSegment,
				),
				new NonTerminalExpression<OptionalStartingWithWordFunctionCallStatementSegmentsRestConcreteSyntaxTreeNode>(
