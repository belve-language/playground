import {functionHeaderSegmentsRuleName} from "./name/functionHeaderSegmentsRuleName.ts";
...
export class FunctionHeaderSegmentsRule extends Rule<
	FunctionHeaderSegmentsConcreteSyntaxTreeNodeAtom,
	FunctionHeaderSegmentsConcreteSyntaxTreeNode
> {
	public constructor() {
		super(functionHeaderSegmentsRuleName);
	}
