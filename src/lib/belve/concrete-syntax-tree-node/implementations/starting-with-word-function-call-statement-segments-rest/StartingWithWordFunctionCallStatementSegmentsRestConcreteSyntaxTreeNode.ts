	...
	public abstractify():
		...
		switch (functionCallStatementSegmentsAbstractifyingResult.typeName) {
			case errorAbstractifyingResultTypeName: {
				const startingWithWordFunctionCallStatementSegmentsRestAbstractifyingResult: ErrorAbstractifyingResult =
					new ErrorAbstractifyingResult(
						functionCallStatementSegmentsAbstractifyingResult.message,
					);
				return startingWithWordFunctionCallStatementSegmentsRestAbstractifyingResult;
			}
			case successAbstractifyingResultTypeName: {
				...
				const startingWithWordFunctionCallStatementSegmentsRestAbstractifyingResult: SuccessAbstractifyingResult<
					readonly SupportedFunctionCallStatementSegmentAbstractSyntaxTreeNode[]
