	...
	public abstractify():
		...
		switch (blockStatementContentAbstractifyingResult.typeName) {
			...
			case successAbstractifyingResultTypeName: {
				...
				if (abstractifiedBlockStatementContent === null) {
					...
					const abstractifiedOptionalBlockStatementContent: BlockStatementAbstractSyntaxTreeNodeChildren =
					...
					const optionalBlockStatementContentAbstractifyingResult: SuccessAbstractifyingResult<BlockStatementAbstractSyntaxTreeNodeChildren> =
						new SuccessAbstractifyingResult<BlockStatementAbstractSyntaxTreeNodeChildren>(
