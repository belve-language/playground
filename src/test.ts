...
import {successAbstractifyingResultTypeName} from "./lib/core/abstractifying-result/implementations/success/type-name/successAbstractifyingResultTypeName.ts";
